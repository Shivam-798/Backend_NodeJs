...
const generateAccessAndRefereshTokens = async(userId) => {
   ...
   try{
        ...
        console.log("user aya hai ki nahi"+ user)
...
const registerUser = asyncHandler( async (req, res) => {
    ...
    //upload then to clouinary, avatar
    ...
    const existeddUser = await User.findOne({
        $or: [{username}, {email}]
    })
...
"-password -refreshToken"
  ...
  // jo response aya hai usme ye do field nahi hogi
...
const loginUser = asyncHandler(async (req, res) => {
   ...
   const user = await User.findOne({
    ...
    // ye find karega ya to user mil jaye ya email mil jaye
